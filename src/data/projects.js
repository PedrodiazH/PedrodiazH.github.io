export const projects = [
  {
    id: 1,
    title: 'Heissen QRNG',
    description: 'Proyecto móvil en colaboración con Synapta, que busca acercar la cuántica a aplicaciones cotidianas. Utilizando la API de ANU QRNG para sorteos, decisiones y lanzamientos de dados con aleatoriedad cuántica.',
  ...
  {
    id: 2,
    title: 'Desarrollo de algoritmos de IA explicables para el reconocimiento de emociones basado en videos de expresiones faciales',
    description: 'Proyecto de Título desarrollado junto a mi compañero Marcos Carripan. Revisión del estado del arte de FER, implementación del modelo ResEmoteNet, y explicabilidad comparando método LIME y SHAP.',
  ...
  {
    id: 3,
    title: 'Libro de Remuneraciones con Liquidación de sueldo automática',
    description: 'Proyecto de Software tipo Local Web App. Diseñado a medida, sistema robusto y con redacción automática de liquidación de sueldo en PDF.',
